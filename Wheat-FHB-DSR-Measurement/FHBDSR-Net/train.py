...
def parse_opt(known=False):
    ...
    parser.add_argument('--weights', type=str, default='/home/wuz/fhb_project/code/v9-ff/ff-all/yolov9/gelan-c.pt', help='initial weights path')
    parser.add_argument('--cfg', type=str, default='/home/wuz/fhb_project/code/v9-ff/ff-all/yolov9/models/detect/gelan-s-myself.yaml', help='model.yaml path')
    parser.add_argument('--data', type=str, default=ROOT / '/home/wuz/fhb_project/code/v9-ff/ff-all/yolov9/data/620.yaml', help='dataset.yaml path')
